sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("example/app/flc-northwind/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#FLCMasterDetailApp-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#FLCMasterDetailApp-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("example.app.flc-northwind.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["example/app/flc-northwind/localService/mockserver"], function (mockserver) {
