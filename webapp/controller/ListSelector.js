sap.ui.define([
		...
		return BaseObject.extend("example.app.flc-northwind.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias example.app.flc-northwind.controller.ListSelector
			 */
			 ...
			 * @return {example.app.flc-northwind.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
